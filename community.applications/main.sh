...
###
 ...
 # @LastEditTime: 2023-02-25 10:32:59
...
echo "替换 ${AUTHOR} 的 ${NAME}"
#sed -i "s/https:\/\/raw.githubusercontent.com\/${AUTHOR}\/${NAME}\/master\//https:\/\/gitcode.net\/juzhijian\/${NAME}\/-\/raw\/master\//g" $(grep "https://raw.githubusercontent.com/${AUTHOR}/${NAME}/master/" -rl ./)
grep -rl "https://raw.githubusercontent.com/${AUTHOR}/${NAME}/master/" ./tmp/GitHub/${APPNAME} | xargs sed -i "s/https:\/\/raw.githubusercontent.com\/${AUTHOR}\/${NAME}\/master\//https:\/\/gitcode.net\/juzhijian\/${NAME}\/-\/raw\/master\//g"
